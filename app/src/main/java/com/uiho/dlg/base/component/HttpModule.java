...
public class HttpModule {
    ...
    @Provides
    @GUrl
    Retrofit provideWulingRetrofit(Retrofit.Builder builder, OkHttpClient client) {
        Log.i("TAG", "--provideGankRetrofit");
        return createRetrofit(builder, client, Api.HOST);//GankApis
    }


    @Singleton
    @Provides
    Api provideWulingService(@GUrl Retrofit retrofit) {
